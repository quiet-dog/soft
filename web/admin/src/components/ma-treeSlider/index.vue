<template>
  <div class="flex flex-col w-full h-full">
    ...
    <a-tree blockNode ref="maTree" :data="treeData" class="h-full w-full" @select="handlerSelect"
      :field-names="props.fieldNames" v-model:selected-keys="modelValue" v-bind="$attrs">
