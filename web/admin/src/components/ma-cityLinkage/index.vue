<template>
  <a-cascader v-if="props.type === 'cascader'" v-model="val" :field-names="props.mode == 'name'
      ? { value: 'name', label: 'name' }
      : { value: 'code', label: 'name' }
    " :options="jsonData" allow-search check-strictly expand-trigger="hover" path-mode placeholder="请选择省市区" />
  <a-space v-else>
    <a-select v-model="selectData.province" :field-names="props.mode == 'name'
        ? { value: 'name', label: 'name' }
        : { value: 'code', label: 'name' }
      ...
      @change="provinceChange" @clear="() => {
        ...
        " />
    <a-select v-model="selectData.city" :field-names="props.mode == 'name'
        ? { value: 'name', label: 'name' }
        : { value: 'code', label: 'name' }
      ...
      @change="cityChange" @clear="() => {
        ...
        " />
    <a-select v-model="selectData.area" :field-names="props.mode == 'name'
        ? { value: 'name', label: 'name' }
        : { value: 'code', label: 'name' }
