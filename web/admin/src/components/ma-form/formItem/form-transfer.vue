<template>
  <ma-form-item v-if="(typeof props.component.display == 'undefined' || props.component.display === true)"
    ...
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-transfer v-model="value" :show-search="props.component.showSearch"
        :show-select-all="props.component.showSelectAll"
        :title="typeof props.component.title == 'array' ? props.component.title : ['源数据', '目标数据']"
        :disabled="props.component.disabled" :simple="props.component.simple"
        :data="props.component.data ?? dictList[dictIndex] ?? []" :fallback="props.component.fallback"
        @change="rv('onChange', $event)" @select="rv('onSelect', $event)">
      </a-transfer>
    </slot>
  </ma-form-item>
</template>
