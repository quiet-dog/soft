<template>
  <ma-form-item v-if="(typeof props.component.display == 'undefined' || props.component.display === true)"
    ...
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-input-tag v-model="value" :input-value="props.component.inputValue" :size="props.component.size"
        ...
        :max-tag-count="props.component.maxTagCount" :retain-input-value="props.component.retainInputValue"
        :format-tag="props.component.formatTag" :unique-value="props.component.uniqueValue"
        :field-names="props.component.fieldNames" @input-value-change="rv('onInputValueChange', $event)"
        @change="rv('onChange', $event)" @remove="rv('onRemove', $event)" @press-enter="rv('onPressEnter', $event)"
