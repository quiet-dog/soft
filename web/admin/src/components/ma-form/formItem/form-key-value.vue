<template>
  <ma-form-item v-if="(typeof props.component.display == 'undefined' || props.component.display === true)"
    ...
    <slot :name="`form-${props.component.dataIndex}`" v-bind="props.component">
      <a-table class="w-full" row-key="keys" :pagination="false" @change="handleChange" :data="value"
        ...
        <template #columns>
          ...
          <a-table-column title="操作" align="center">
            <template #cell="{ rowIndex }">
              <a-space>
                <a-button size="small" type="primary" @click="plus(rowIndex)"><template
                    #icon><icon-plus /></template></a-button>
                <a-button size="small" type="primary" @click="minus(rowIndex)"><template
                    #icon><icon-minus /></template></a-button>
              </a-space>
            </template>
          </a-table-column>
        </template>
