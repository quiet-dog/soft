<template>
    <svg viewBox="0 0 1024 1024" class="icon" xmlns="http://www.w3.org/2000/svg">
        <path d="M1109.12 786.49856a157.44 157.44 0 1 0 314.88 0 157.44 157.44 0 1 0-314.88 0Z" fill-opacity="null"
            p-id="621"></path>
        <path d="M359.81067 146.988593l282.234494 139.61771-284.910937 575.941934-282.234494-139.61771z"
            fill-opacity="null" p-id="622"></path>
        <path
            d="M357.540463 151.577771a157.44 157.44 0 1 0 282.234494 139.617711 157.44 157.44 0 1 0-282.234494-139.617711Z"
            fill-opacity="null" p-id="623"></path>
        <path
            d="M78.306178 716.044464a157.44 157.44 0 1 0 282.234494 139.61771 157.44 157.44 0 1 0-282.234494-139.61771Z"
            fill-opacity="null" p-id="624"></path>
        <path d="M897.31851 146.988593l282.234494 139.61771-284.910937 575.941934-282.234494-139.61771z"
            fill-opacity="null" p-id="625"></path>
        <path
            d="M895.048303 151.577771a157.44 157.44 0 1 0 282.234494 139.617711 157.44 157.44 0 1 0-282.234494-139.617711Z"
            fill-opacity="null" p-id="626"></path>
        <path
            d="M615.814018 716.044464a157.44 157.44 0 1 0 282.234494 139.61771 157.44 157.44 0 1 0-282.234494-139.61771Z"
            fill-opacity="null" p-id="627"></path>
    </svg>
</template>