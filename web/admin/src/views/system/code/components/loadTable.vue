...
-->
<template>
  <a-modal width="1100px" v-model:visible="visible" :on-before-ok="loadTable" :align-center="false" top="50px"
    unmount-on-close>
...
<script setup>
  ...
  import dataSource from '@/api/system/datasource'
  ...
  const switchSource = () => {
    ...
    crudRef.value.requestParams['group_name'] = sourceName.value
