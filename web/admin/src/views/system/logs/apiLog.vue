<template>
  <div class="ma-content-block lg:flex justify-between p-4">
    ...
    <a-drawer v-model:visible="visible" width="600px" :footer="false">
            ...
            <tbody>
              <tr class="arco-descriptions-row">
                ...
                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">{{
                  currentRow?.api_name }}</td>
              </tr>
              <tr class="arco-descriptions-row">
                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">接口标识</td>
                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">{{
                  currentRow?.access_name }}</td>
              </tr>
              <tr class="arco-descriptions-row">
                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">状态代码</td>
                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">{{
                  currentRow?.response_code }}</td>
              </tr>
              <tr class="arco-descriptions-row">
                <td class="arco-descriptions-item-label arco-descriptions-item-label-block">请求时间</td>
                <td class="arco-descriptions-item-value arco-descriptions-item-value-block" colspan="1">{{
                  currentRow?.access_time }}</td>
              </tr>
              <tr class="arco-descriptions-row">
      ...
      <a-collapse :default-active-key="['request', 'response']" expand-icon-position="right" class="mt-3">
...
<script setup>
  ...
  const columns = reactive([
    ...
    { title: '接口标识', dataIndex: 'access_name', search: true, width: 180 },
