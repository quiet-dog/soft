        ...
        <a-spin :loading="loading" tip="部门加载中..." class="w-full">
          <div class="w-full">
            ...
            <div class="tree-container p-2">
              <ma-tree-slider ref="tree" :data="deptList" checkable :fieldNames="{ title: 'label', key: 'id' }"
                searchPlaceholder="过滤部门" v-model:checked-keys="selectKeys" :check-strictly="cancelLinkage"
